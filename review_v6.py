...
import backoff
from utils4 import  total_cost_calc
...
def main():
    ...
    total_prompt_tokens, total_completion_tokens, successful_responses, failed_responses = process_reviews(client, INPUT_FILE)
    #cost_calc(successful_responses)
    total_cost_calc(total_prompt_tokens, total_completion_tokens)
